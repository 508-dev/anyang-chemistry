...
#
# TEMPLATE NOTE: replace `dev.co508.example` (package_name), `example`
# (display name / landing-page copy), and the GitHub repo URLs below with the
# real app's values.
set -euo pipefail
...
package_name=dev.co508.example
...
<title>Example App &mdash; F-Droid repository</title>
<style>
...
<a href="https://github.com/508-dev/example">Example App</a>.</p>
...
<p><a href="https://github.com/508-dev/example">Source code</a> &middot; GPL-3.0</p>
</html>
""")
PY
